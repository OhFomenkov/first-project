    ...
    class Program
    {
        static void Vzaim(List<Client> clients, Hotel ht, Admin admin)
        {
            ...
            move = Convert.ToInt32(Console.ReadLine());
                ...
                File.WriteAllText("C:\\Users\\user\\Desktop\\labC#\\lab9\\lab9\\data layer\\client.json", jsonq);
            }
        }
        ...
        static void AddClient(List<Client> clients, List<CreditCardClient> cards)
        {
            ...
            if (f == 1)
            {
                ...
                File.WriteAllText("C:\\Users\\user\\Desktop\\labC#\\lab9\\lab9\\data layer\\Cards.json", json);
        ...
        {
            StreamWriter sw = new StreamWriter("C:\\Users\\user\\Desktop\\labC#\\lab9\\lab9\\magazine.txt");
            List<CreditCardClient> cards = CreditCardClient.LoadClientsCardsFromJson("C:\\Users\\user\\Desktop\\labC#\\lab9\\lab9\\data layer\\Cards.json");
            List<Client> clients = Client.LoadClientsFromJson("C:\\Users\\user\\Desktop\\labC#\\lab9\\lab9\\data layer\\client.json");
